...
public final class SimpleSharedPreference {
    ...
    /**
     * Deprecated:
     * Use different names is better.
     * If all key-value use one file name, it will reduce performance.
     *
     * @param ctx
     * @return
     */
    ...
    public boolean equals(Object o) {
        return o instanceof SimpleSharedPreference && ((SimpleSharedPreference) o).getName().equals(this.getName());
    }
